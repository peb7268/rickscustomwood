...
<p><input type="text" name="author" id="author" class="commentinput" value="<?php echo $comment_author; ?>" size="22" tabindex="1" />
<label for="author">Name <?php if ($req) echo "(required)"; ?></label></p>

<p><input type="text" name="email" id="email" class="commentinput" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" />
<label for="email">Mail (will not be published) <?php if ($req) echo "(required)"; ?></label></p>

<p><input type="text" name="url" id="url" class="commentinput" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
...
<p><textarea name="comment" id="comment" class="commentarea" rows="10" tabindex="4"></textarea></p>
