...
#fullsize { position:relative; z-index:1; overflow:hidden; width:766px; height:<?php echo ((int) $styles['height'] - 6); ?>px; }
#information { font-family:Verdana, Arial, Helvetica, sans-serif !important; position:absolute; bottom:0; width:100%; height:0; background:<?php echo $styles['infobackground']; ?>; color:<?php echo $styles['infocolor']; ?>; overflow:hidden; z-index:200; opacity:.7; filter:alpha(opacity=70); }
